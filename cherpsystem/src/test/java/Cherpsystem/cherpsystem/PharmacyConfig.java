...
public class PharmacyConfig {
	...
	//{
	  ...
	  //Click Pharmacy
		...
		Pharmacy.click(); 
	 	WebElement Pharmacyconfig= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Pharmacy Config']"))); 
	 	Pharmacyconfig.click();
	Thread.sleep(2000);
	
	//Search and Clear
	
	driver.findElement(By.id("pharmacyfacilityname")).sendKeys("Acadia Test");
	driver.findElement(By.id("pharmacyfacilitycode")).sendKeys("GAAC");
	...
	Thread.sleep(1500);
	driver.findElement(By.id("pharmacyfacilityname")).clear();
	driver.findElement(By.id("pharmacyfacilityname")).sendKeys("Acadia Test");
	driver.findElement(By.id("pharmacyfacilitycode")).clear();
	driver.findElement(By.id("pharmacyfacilitycode")).sendKeys("GAAC1");
  ...
  WebElement ele = driver.findElement(By.xpath("(//option[@value='10'])[1]")); 
  act.doubleClick(ele).perform();
  
    
  WebElement ele1 = driver.findElement(By.xpath("(//option[@value='1'])[1]")); 
  act.doubleClick(ele1).perform();
  
  WebElement ele2 = driver.findElement(By.xpath("(//option[@value='8'])[1]")); 
  ...
  Thread.sleep(500);
    ...
    driver.findElement(By.id("pharmacyfacilityname")).sendKeys("Akilan Test");
    driver.findElement(By.id("pharmacyfacilitycode")).sendKeys("GAAC1");
  ...
  //Page Navigation
	 WebElement pagenavigation = driver.findElement(By.name("facilitySummaryTable_length"));
	    Select select4 = new Select(pagenavigation);
	    select4.selectByVisibleText("25");
	    Thread.sleep(1000);
	    WebElement nextpage = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("facilitySummaryTable_last")));
	    nextpage.click();
	    Thread.sleep(1500);
	    WebElement previous = wait.until(ExpectedConditions.visibilityOfElementLocated(By.id("facilitySummaryTable_first")));
	    previous.click();
	    Thread.sleep(1500);
	  }}