...
public class BCBSDetailedreport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Reports.click(); 
		 	Thread.sleep(3000);
		 	WebElement BCBSReport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='BCBS Reports']"))); 
		 	BCBSReport.click();
		 	WebElement BCBSdetailedreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='BCBS Detailed Report']"))); 
		 	BCBSdetailedreport.click();
	Thread.sleep(2000);
