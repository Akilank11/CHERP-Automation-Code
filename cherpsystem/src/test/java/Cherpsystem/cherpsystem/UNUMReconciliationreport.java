...
public class UNUMReconciliationreport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Reports.click(); 
		 	Thread.sleep(3000);
		 	WebElement UNUMReports = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='UNUM Reports']"))); 
		 	UNUMReports.click();
		 	WebElement UNUMReconciliationReports = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='UNUM Reconciliation Report']"))); 
		 	UNUMReconciliationReports.click();
	Thread.sleep(2000);
