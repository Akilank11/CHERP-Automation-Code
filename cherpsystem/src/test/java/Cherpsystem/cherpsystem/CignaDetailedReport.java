...
public class CignaDetailedReport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Reports.click(); 
		 	Thread.sleep(3000);
		 	WebElement CignaReport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='CIGNA Reports']"))); 
		 	CignaReport.click();
		 	WebElement CignaDetailedreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='CIGNA Detailed Report']"))); 
		 	CignaDetailedreport.click();
	Thread.sleep(2000);
	
	//Search Function
	
	WebElement Company = driver.findElement(By.id("companyGroupCode"));
	Select Companyselect = new Select(Company);
	Companyselect.selectByVisibleText("CorrectHealth");
