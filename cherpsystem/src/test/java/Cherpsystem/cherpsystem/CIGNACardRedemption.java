...
public class CIGNACardRedemption {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	CignaReport.click();
		 	WebElement Cignacardredemptionreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='CIGNA Card Redemption Report']"))); 
		 	Cignacardredemptionreport.click();
	Thread.sleep(2000);
