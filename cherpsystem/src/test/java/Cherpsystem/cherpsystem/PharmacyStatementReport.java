...
public class PharmacyStatementReport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	WebElement Statementreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Statement Report']"))); 
		 	Statementreport.click();
	Thread.sleep(2000);
