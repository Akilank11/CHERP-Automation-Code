...
public class Bcbsreconciliation {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
			...
			WebElement BCBSReport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='BCBS Reports']"))); 
		 	BCBSReport.click();
		 	WebElement BCBSReconciliation = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='BCBS Reconciliation Report']"))); 
		 	BCBSReconciliation.click();
	Thread.sleep(2000);
