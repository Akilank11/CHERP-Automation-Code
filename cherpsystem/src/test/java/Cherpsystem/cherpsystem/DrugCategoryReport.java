...
public class DrugCategoryReport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	WebElement DrugCategoryReport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Drug Category Report']"))); 
		 	DrugCategoryReport.click();
	Thread.sleep(2000);
    ...
    WebElement DrugCategory = driver.findElement(By.id("categoryid"));
	Select DrugCategoryselect = new Select(DrugCategory);
	DrugCategoryselect.selectByVisibleText("Pt Spec Form");
	...
	driver.findElement(By.xpath("//button[normalize-space()='>>']")).click();
	 ...
	 driver.findElement(By.xpath("//button[normalize-space()='Drug Category Report - Group by Facility']")).click();
	 Thread.sleep(1000);
	 //driver.findElement(By.xpath("//button[normalize-space()='Drug Category Report - Group by DOS Date']")).click();
	 //Thread.sleep(1000);
