...
public class MonthlyMiscellaneousRevenue {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Revenuereport.click();
		 	WebElement MonthlyMiscellaneousRevenue = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='AR Misc Revenue Reports']"))); 
		 	MonthlyMiscellaneousRevenue.click();
	Thread.sleep(2000);
    ...
    WebElement InvoiceType = driver.findElement(By.id("invoiceType"));
