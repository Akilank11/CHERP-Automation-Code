...
public class ContractsRenewalAlert {
	...
	Thread.sleep(1000);
	WebElement ContractsRenewalAlert= wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Contracts Renewal Alert Report']"))); 
	ContractsRenewalAlert.click();
	Thread.sleep(2000);
