...
public class CensusforInvoicingReport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Reports.click(); 
		 	Thread.sleep(3000);
		 	WebElement Invoices = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("(//a[contains(text(),'Invoices')])[13]"))); 
		 	Invoices.click();
		 	WebElement CensusforinvoiceReports = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Census for Invoicing Report']"))); 
		 	CensusforinvoiceReports.click();
	Thread.sleep(2000);
