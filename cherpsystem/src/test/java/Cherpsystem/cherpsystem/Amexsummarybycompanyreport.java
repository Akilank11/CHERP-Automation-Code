...
public class Amexsummarybycompanyreport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Amex.click();
		 	WebElement Summarybycompanyreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Summary By Company Report']"))); 
		 	Summarybycompanyreport.click();
	Thread.sleep(2000);
