...
public class UNUMDetailedReport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	UnumREPORT.click();
		 	WebElement Unumdetailedreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='UNUM Detailed Report']"))); 
		 	Unumdetailedreport.click();
	Thread.sleep(2000);
	//Search Function
