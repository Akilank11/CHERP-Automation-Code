...
public class CensusTrendAnalysisReport {
		...
		//{
		    ...
		    public void loginTest() throws InterruptedException {
		    	...
		    	Reports.click(); 
			 	...
			 	Invoices.click(); 
			 	Thread.sleep(3000);
			 	WebElement CensusTrendAnalysisReport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Census Trend Analysis Report']"))); 
			 	CensusTrendAnalysisReport.click();
		Thread.sleep(2000);
