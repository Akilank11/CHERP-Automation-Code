...
public class Bcbssummaryreport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	BCBSReport.click();
		 	WebElement BCBSSummaryreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='BCBS Summary Report']"))); 
		 	BCBSSummaryreport.click();
	Thread.sleep(2000);
