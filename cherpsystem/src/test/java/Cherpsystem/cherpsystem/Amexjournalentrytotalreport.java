...
public class Amexjournalentrytotalreport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Amex.click();
		 	WebElement Journalentrytotalreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[@href='/CHERPSystem/report/journalEntryTotalsReport']"))); 
		 	Journalentrytotalreport.click();
	Thread.sleep(2000);
	...
	Facilityselect.selectByVisibleText("All");
	   ...
	   driver.findElement(By.id("dateFrom")).click();
	    ...
	    Todateselect.click();
	    Thread.sleep(1000);
	    driver.findElement(By.id("newSearch"));
	    Thread.sleep(1000);
  }
}
