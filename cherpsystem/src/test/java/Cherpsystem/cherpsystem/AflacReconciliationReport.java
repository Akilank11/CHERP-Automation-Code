...
public class AflacReconciliationReport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	Reports.click(); 
		 	Thread.sleep(3000);
		 	WebElement AflacReports = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Aflac Reports']"))); 
		 	AflacReports.click();
		 	WebElement AflacReconciliationReports = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Aflac Reconciliation Report']"))); 
		 	AflacReconciliationReports.click();
	Thread.sleep(2000);
