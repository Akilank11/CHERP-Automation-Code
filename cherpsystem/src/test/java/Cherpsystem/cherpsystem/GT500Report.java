...
public class GT500Report {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	WebElement GT500Report = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='Pharmacy GT 500 Report']"))); 
		 	GT500Report.click();
	Thread.sleep(2000);
    ...
    WebElement InvoiceFromDate = wait1.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//button[@type='button'])[10]")));
    ...
    WebElement InvoiceToDate = wait2.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("(//button[@type='button'])[16]")));
    InvoiceToDate.click();
    ...
    WebElement Pharmacy = driver.findElement(By.id("vendorid"));
	Select Pharmacyselect = new Select(Pharmacy);
	Pharmacyselect.selectByVisibleText("DIAMOND PHARMACY SERVICES");
	
    WebElement PrescriberName	= driver.findElement(By.id("categoryid"));
	Select PrescriberNameselect = new Select(PrescriberName);
	PrescriberNameselect.selectByVisibleText("All");
	...
	driver.findElement(By.xpath("//button[normalize-space()='>>']")).click();
	 ...
	 driver.findElement(By.xpath("//button[normalize-space()='Pharmacy GT500 Report']")).click();
	 Thread.sleep(1000);
