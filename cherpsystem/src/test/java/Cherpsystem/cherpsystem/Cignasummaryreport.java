...
public class Cignasummaryreport {
	...
	//{
	    ...
	    public void loginTest() throws InterruptedException {
	    	...
	    	WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
		 	...
		 	CignaReport.click();
		 	WebElement CignaSummaryreport = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//a[normalize-space()='CIGNA Summary Report']"))); 
		 	CignaSummaryreport.click();
	Thread.sleep(2000);
